---
title: Data Sources
description: Where kardashev's data comes from for each of the 7 US ISOs/RTOs — direct scraper sources, the hosted API's upstream feeds, and refresh cadence.
---
